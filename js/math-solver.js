...
const MULTIPLY_DIVIDE_REGEX = /(?<operand0>(?<!\s*\d+\s*)-?\d*\.?\d+(?:[eE][+-]?\d+)?)\s*(?<operator>[*\/])\s*(?<operand1>-?\d*\.?\d+(?:[eE][+-]?\d+)?)/;
const ADD_SUBTRACT_REGEX = /(?<operand0>(?<!\s*\d+\s*)-?\d*\.?\d+(?:[eE][+-]?\d+)?)\s*(?<!e)(?<operator>[+-])\s*(?<operand1>-?\d*\.?\d+(?:[eE][+-]?\d+)?)/;
